...
class WaterPump extends StatefulWidget {
  ...
  @override
  State<WaterPump> createState() => _WaterPump();
}

class _WaterPump extends State<WaterPump> {
          ...
          if (snapshot.hasData) {
            ...
            return Column(
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    if (sensorValues['pump-open'].toString() == "true") {
                      Toast.show(context, "Pump is already open!");
                    } else {
                      updatePumpStatus("true");
                      Toast.show(context, "Sending command to open pump.");
                    }
                  },
                  style: ButtonStyle(
...
void updatePumpStatus(String isOpen) {
  DatabaseReference ref = FirebaseDatabase.instance.ref("/sensors/pump-open");
  ref.set(isOpen);
}
